...
У лівій панелі Project знайди папку python-analytics-homework. Натисни правою кнопкою миші на назві папки, наведи курсор на пункт New і в підменю натисни Python File. Введи назву файлу: analysisі натисни Enter.
